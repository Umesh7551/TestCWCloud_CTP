...
class AddSupplierTest(unittest.TestCase):
    def __init__(self, methodName='test_add_supplier', data=None):
    ...
    def test_add_supplier(self):
        if self.data:
            ...
            business_unit = self.data["test_add_supplier"]["Business_Unit"]
            ...
            supplier_code = self.data["test_add_supplier"]["Supplier_Code"]
            ...
            name = self.data["test_add_supplier"]["Name"]
            ...
            price_list = self.data["test_add_supplier"]["Price_List"]
            ...
            description = self.data["test_add_supplier"]["Description"]
            ...
            reference_no = self.data["test_add_supplier"]["Reference_no"]
            ...
            gst_no = self.data["test_add_supplier"]["GST_No"]
            ...
            payment_method = self.data["test_add_supplier"]["Payment_Method"]
            ...
            payment_terms = self.data["test_add_supplier"]["Payment_Terms"]
            ...
            currency = self.data["test_add_supplier"]["Currency"]
            ...
            lead_days = self.data["test_add_supplier"]["Lead_Days"]
