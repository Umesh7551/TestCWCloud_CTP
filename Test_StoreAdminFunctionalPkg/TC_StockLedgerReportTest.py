...
class StockLedgerReportTest(unittest.TestCase):
    ...
    def test_stock_ledger_report(self):
        if self.data:
            ...
            # time.sleep(5)
            # username = self.data['test_stock_ledger_report']['username']
            # password = self.data['test_stock_ledger_report']['password']
            ...
            business_unit = self.data['test_stock_ledger_report']['Business_Unit']
            ...
            storage_location = self.data['test_stock_ledger_report']['Storage_Location']
            ...
            product_category = self.data['test_stock_ledger_report']['Product_Category']
            ...
            product = self.data['test_stock_ledger_report']['Product']
