...
class InventoryAdjustmentReportTest(unittest.TestCase):
    ...
    def test_inventory_adjustment_report(self):
        if self.data:
            ...
            time.sleep(5)
            username = self.data['test_inventory_adjustment_report']['username']
            password = self.data['test_inventory_adjustment_report']['password']
            ...
            business_unit = self.data['test_inventory_adjustment_report']['Business_Unit']
            ...
            product_category = self.data['test_inventory_adjustment_report']['Product_Category']
            ...
            product = self.data['test_inventory_adjustment_report']['Product']
