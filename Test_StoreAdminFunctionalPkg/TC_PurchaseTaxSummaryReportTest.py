...
class PurchaseTaxSummaryReportTest(unittest.TestCase):
    def __init__(self, methodName='test_purchase_tax_summary_report', data=None):
        super(PurchaseTaxSummaryReportTest, self).__init__(methodName)
        self.data = data
    ...
    def test_purchase_tax_summary_report(self):
        if self.data:
            ...
            time.sleep(5)
            username = self.data['test_purchase_tax_summary_report']['username']
            password = self.data['test_purchase_tax_summary_report']['password']
            ...
            business_unit = self.data['test_purchase_tax_summary_report']['Business_Unit']
            ...
            tax_category = self.data['test_purchase_tax_summary_report']['Tax_Category']
