...
class AddPOSOrdersTest(unittest.TestCase):
    ...
    def test_add_pos_orders(self):
        if self.data:
            ...
            store = self.data["test_add_pos_orders"]["Store"]
            ...
            document_no = self.data["test_add_pos_orders"]["Document_No"]
            ...
            b2c_customer = self.data["test_add_pos_orders"]["B2C_Customer"]
            ...
            price_list = self.data["test_add_pos_orders"]["Price_List"]
            ...
            payment_method = self.data["test_add_pos_orders"]["Payment_Method"]
