...
class InTransitStockReportTest(unittest.TestCase):
    def __init__(self, methodName='test_in_transit_stock_report', data=None):
        super(InTransitStockReportTest, self).__init__(methodName)
        self.data = data
    ...
    def test_in_transit_stock_report(self):
        if self.data:
            ...
            time.sleep(5)
            username = self.data['test_in_transit_stock_report']['username']
            password = self.data['test_in_transit_stock_report']['password']
            ...
            business_unit = self.data['test_in_transit_stock_report']['Business_Unit']
