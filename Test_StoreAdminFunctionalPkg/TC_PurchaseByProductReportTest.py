...
class PurchaseByProductReportTest(unittest.TestCase):
    def __init__(self, methodName='test_purchase_by_product_report', data=None):
        super(PurchaseByProductReportTest, self).__init__(methodName)
        self.data = data
    ...
    def test_purchase_by_product_report(self):
        if self.data:
            ...
            time.sleep(5)
            username = self.data['test_purchase_by_product_report']['username']
            password = self.data['test_purchase_by_product_report']['password']
            ...
            business_unit = self.data['test_purchase_by_product_report']['Business_Unit']
            ...
            supplier = self.data['test_purchase_by_product_report']['Supplier']
            ...
            product_name = self.data['test_purchase_by_product_report']['Product_Name']
