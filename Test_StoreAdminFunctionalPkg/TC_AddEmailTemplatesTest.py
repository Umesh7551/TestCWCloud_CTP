...
class AddEmailTemplatesTest(unittest.TestCase):
    def __init__(self, methodName='test_add_email_templates', data=None):
    ...
    def test_add_email_templates(self):
        if self.data:
            ...
            business_unit = self.data["test_add_email_templates"]["Business_Unit"]
            ...
            name = self.data["test_add_email_templates"]["Name"]
            ...
            subject = self.data["test_add_email_templates"]["Subject"]
            ...
            from_email = self.data["test_add_email_templates"]["From_Email"]
            ...
            reply_to = self.data["test_add_email_templates"]["Reply_To"]
            ...
            to_email = self.data["test_add_email_templates"]["To_Email"]
            ...
            cc_email = self.data["test_add_email_templates"]["CC_Email"]
