...
class PendingStockIssueReportTest(unittest.TestCase):
    def __init__(self, methodName='test_pending_stock_issue_report', data=None):
        super(PendingStockIssueReportTest, self).__init__(methodName)
        self.data = data
    ...
    def test_pending_stock_issue_report(self):
        if self.data:
            ...
            # time.sleep(5)
            # username = self.data['test_pending_stock_issue_report']['username']
            # password = self.data['test_pending_stock_issue_report']['password']
            ...
            business_unit = self.data['test_pending_stock_issue_report']['Business_Unit']
