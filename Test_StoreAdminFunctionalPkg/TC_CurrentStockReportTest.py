...
class CurrentStockReportTest(unittest.TestCase):
    def __init__(self, methodName='test_current_stock_report', data=None):
        super(CurrentStockReportTest, self).__init__(methodName)
        self.data = data
    ...
    def test_current_stock_report(self):
        if self.data:
            ...
            time.sleep(5)
            username = self.data['test_current_stock_report']['username']
            password = self.data['test_current_stock_report']['password']
            ...
            business_unit = self.data['test_current_stock_report']['Business_Unit']
            ...
            storage_location = self.data['test_current_stock_report']['Storage_Location']
