...
class LowStockReportTest(unittest.TestCase):
    ...
    def test_low_stock_report(self):
        if self.data:
            ...
            time.sleep(5)
            username = self.data['test_low_stock_report']['username']
            password = self.data['test_low_stock_report']['password']
            ...
            business_unit = self.data['test_low_stock_report']['Business_Unit']
            ...
            storage_location = self.data['test_low_stock_report']['Storage_Location']
