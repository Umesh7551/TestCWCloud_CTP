...
class AmountWiseNOBReportTest(unittest.TestCase):
    def __init__(self, methodName='test_amount_wise_nob_report', data=None):
        super(AmountWiseNOBReportTest, self).__init__(methodName)
        self.data = data
    ...
    def test_amount_wise_nob_report(self):
        if self.data:
            ...
            # time.sleep(5)
            # username = self.data['test_amount_wise_nob_report']['username']
            # password = self.data['test_amount_wise_nob_report']['password']
            ...
            store = self.data['test_amount_wise_nob_report']['Store']
